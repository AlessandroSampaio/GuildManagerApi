...
namespace GuildManagerApi.Api.Migrations
{
    ...
    [Migration("20260408173003_Fix_MythicRun_RemoveKeystoneRunId_AddDungeonUniqueIndex")]
    partial class Fix_MythicRun_RemoveKeystoneRunId_AddDungeonUniqueIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GuildManagerApi.Domain.Entities.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("GuildManagerApi.Domain.Entities.RaiderIoMythicRun", b =>
                {
                    ...
                    b.HasIndex("SnapshotId", "Dungeon")
                        .IsUnique();

                    b.ToTable("raiderio_mythic_runs", (string)null);
                });

            modelBuilder.Entity("GuildManagerApi.Domain.Entities.RaiderIoRaidProgression", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("HeroicBossesKilled")
                        .HasColumnType("integer")
                        .HasColumnName("heroic_bosses_killed");

                    b.Property<int>("MythicBossesKilled")
                        .HasColumnType("integer")
                        .HasColumnName("mythic_bosses_killed");

                    b.Property<int>("NormalBossesKilled")
                        .HasColumnType("integer")
                        .HasColumnName("normal_bosses_killed");

                    b.Property<string>("RaidSlug")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                        .HasColumnName("raid_slug");
                    ...
                    b.Property<int>("TotalBosses")
                        .HasColumnType("integer")
                        .HasColumnName("total_bosses");

                    b.HasKey("Id");

                    b.HasIndex("SnapshotId", "RaidSlug")
                        .IsUnique();

                    b.ToTable("raiderio_raid_progressions", (string)null);
                });
            ...
            modelBuilder.Entity("GuildManagerApi.Domain.Entities.Player", b =>
                {
                    b.HasOne("GuildManagerApi.Domain.Entities.AppUser", "AppUser")
                        .WithOne("Player")
                        .HasForeignKey("GuildManagerApi.Domain.Entities.Player", "AppUserId")
                        .OnDelete(DeleteBehavior.SetNull);
